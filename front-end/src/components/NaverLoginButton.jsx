...
const NaverLogin = () => {
  ...
  const redirect_uri = encodeURIComponent(import.meta.env.VITE_NAVER_REDIRECT_URI);
  const state = uuidv4();
  ...
  const handleLogin = () => {
    ...
    //console.log("naver: ", naver_login_url);
  ...
  return (
    <div id="naverLogin" onClick={handleLogin}>
      <svg xmlns="http://www.w3.org/2000/svg" width="22" height="23" viewBox="0 0 22 23" fill="none">
        ...
        <path fillRule="evenodd" clipRule="evenodd" d="M13.1047 5.75726V11.9026L8.91812 5.75726H5.25952V17.2383H8.89535V11.093L13.0819 17.2383H16.7405V15.0518V5.75726H13.1047Z" fill="white"/>
      </svg> ''
